# gamupdate
Scripts to update GAM7 if there is an update available, and also show what's new.
...
Simply put the script somewhere in your [Windows PATH](https://www.computerhope.com/issues/ch000549.htm).

Then you can run the update command (updategam7) whenever you want to initiate an update check, and if there is an update, it will be downloaded, unpacked, and the list of updates will be presented to you.

The script will try to figure out where you have installed GAM7 and what type of computer you have, and then download the correct version and unpack it for you.
